    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="'fleX m-2 p-2">
                <a href="{{route('admin.lawyers.index')}}" class="px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white rounded-lg">
                    Юристы
                </a>
            </div>
            <div class="m-2 p-2">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{route('admin.lawyers.update', $lawyer->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div>
                                <img class="w-32 h-32" src="{{Storage::url($lawyer->image )}}">
                            </div>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6">
                            <label for="name" class="block text-sm font-medium text-gray-700"> ФИО юристов </label>
                            <div class="mt-1">
                                <input type="text" id="name" name="name" value="{{$lawyer->name}}" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                        </div>
                        <div class="sm:col-span-6">
                            <label for="city" class="block text-sm font-medium text-gray-700"> Город </label>
                            <div class="mt-1">
                                <input type="text" id="city" name="city" value="{{$lawyer->city}}" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                        </div>
